...
describe('App e2e', () => {
  ...
  describe('Auth', () => {
    ...
    describe('SignUp', () => {
      ...
      it('should signup', () => {
        return pactum.spec().post('/auth/signup').withBody(registerDto).expectStatus(201)
      })
      it('should throw if credentials are taken', () => {
        return pactum.spec().post('/auth/signup').withBody(registerDto).expectStatus(403)
      })
    })
    describe('SignIn', () => {
  ...
  describe('User', () => {
    describe('GetMe', () => {
      it('should get unauthorized', () => {
        return pactum.spec().get('/users/getme').expectStatus(401)
      })
